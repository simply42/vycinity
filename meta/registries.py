...
class ChangeableObjectRegistry(object):
    ...
    def __new__(cls: Type['ChangeableObjectRegistry']) -> 'ChangeableObjectRegistry':
        if ChangeableObjectRegistry.__instance is None:
            ...
            ChangeableObjectRegistry.__instance.register(firewall_models.ListServiceObject, firewall_serializers.ListServiceObjectSerializer, 'objects/services/lists', firewall_views.ListServiceObjectDetail, firewall_views.ListServiceObjectList)
